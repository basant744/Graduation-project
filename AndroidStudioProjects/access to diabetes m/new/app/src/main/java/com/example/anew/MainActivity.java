...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mResult = findViewById(R.id.diabetes_m_result);
        diabetictype=findViewById(R.id.type);


        mPushData = findViewById(R.id.push_data);
        Button mSaveData =  findViewById(R.id.save_data);




        Button readAccess = findViewById(R.id.request_read_access);
        ...
        Button pushAccess = findViewById(R.id.request_push_data_access);
        ...
        mReadData = findViewById(R.id.read_data);
...
*/
    ...
    private void saveData() {
        Intent intent = new Intent(getBaseContext(),ExampleUnitTest.class);
